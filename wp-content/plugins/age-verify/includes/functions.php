...
function av_get_verify_form() {
	...
	$form .= '<form class="form-inline" id="av_verify_form" action="' . esc_url( home_url( '/' ) ) . '" method="post">';
	...
	switch ( $input_type ) {
		...
		case 'dropdowns' :
			...
			$form .= '<select class=" dropdown form-control" data-width="20%" name="av_verify_m" id="av_verify_m">';
			...
			$form .= '</select> <select class="form-control" data-width="20%" name="av_verify_d" id="av_verify_d">';
			...
			$form .= '</select> <select class="form-control" data-width="20%" name="av_verify_y" id="av_verify_y">';
	...
	$form .= '<input type="submit" class="btn btn-primary" style="background: #ed2d66; border-color: #ed2d66; border-radius: 0; margin-left: 4px;
font-size: 16px;" name="av_verify" id="av_verify" value="' . esc_attr( $submit_button_label ) . '" /></p>';
